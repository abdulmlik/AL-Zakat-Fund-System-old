...
{
    class ReportZakatViewModel : BindableBase
    {
        ...
        private void ViewReportExecute()
        {
            ...
            for (DateTime? TStartDate = StartDate ; TStartDate <= EndDate ; TStartDate = TStartDate.Value.AddMonths(1))
            {
                ...
                DTZakat.Rows.Add(NameMonth, TotalZakat, TotalNumberZakat, OfficeRevenue, TotalOfficeZakat, CollectorRevenue, TotalCollectorZakat, BankRevenue, TotalBankZakat);
            }
            #endregion
        ...
        #region Construct
        public ReportZakatViewModel(Window CW)
        {
            CurrentWindow = CW;
