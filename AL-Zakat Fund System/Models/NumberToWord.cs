...
namespace NumberToWord
{
    ...
    //    ToWord toWord = new ToWord(Convert.ToDecimal(txtNumber.Text), currencies[0]);
    //    txtEnglishWord.Text = (toWord.ConvertToEnglish()).ToString().ToUpper();
    //    txtArabicWord.Text = toWord.ConvertToArabic();
    //    txtArabicNumb.Text = toWord.CovertToArabicNumbers();
    //}
    //catch (Exception ex)
    //{
    //    txtEnglishWord.Text = String.Empty;
    //    txtArabicWord.Text = String.Empty;
    //    txtArabicNumb.Text = String.Empty;
    //}

    #region Currency Info
    public class CurrencyInfo
    {
        public enum Currencies { UAE = 0, Syria, SaudiArabia, Libya, Tunisia, Gold };
